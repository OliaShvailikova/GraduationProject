...
public class HorizontalSlidingPane extends Group {
    ...
    private float overscrollDistance = 200;
    ...
    public HorizontalSlidingPane() {
        ...
        sectionWidth  = (float) (Gdx.app.getGraphics().getWidth());
        ...
        actorGestureListener = new ActorGestureListener() {
            ...
            public void touchDown(InputEvent event, float x, float y, int pointer, int button) {
               ...
               /** if ( event.getTarget().getClass() == LevelItem.class ) {
                    touchFocusedChild = event.getTarget();
                } else if (event.getTarget().getClass()== TaskItem.class){
                    touchFocusedChild = event.getTarget();
                }**/
    ...
    void cancelTouchFocusedChild () {
        ...
        try {
            this.getStage().cancelTouchFocus(this.touchFocusedChild);
        } catch (Exception e) {
